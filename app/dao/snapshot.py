...
class SnapshotDAO:
    ...
    @staticmethod
    def get_all_rows_for_current_match_for_league(match_id: int, league_id: int, active: bool = True) -> list[Snapshot]:
        snapshots = Snapshot.query.filter_by(match_id=match_id, league_id=league_id, is_active=active).all()
